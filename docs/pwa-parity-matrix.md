...
|---|---|---|
| Profile selection and roles | Native v1 core | Native identity gateway; parent authorization hardened before release |
...
| Parent people/quest editing | Native v1 core | Basic editor implemented |
| Local notifications | Native v1 core | Boundary present; scheduling follows |
