...
1. In Apple Developer Certificates, Identifiers & Profiles, confirm the final
   kyndyn App ID and create an iCloud container chosen by the project owner.
...
4. Add the Boolean Info property `kyndynCloudSyncConfigured` with value `YES`.
   This is the deliberate switch that allows kyndyn to instantiate
