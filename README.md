...
Build 35 begins enforcing the Premium boundary without weakening Kyndyn's free
family essentials. Advanced quest planning and detailed family insights now
show clear Premium states for free parents, while active and grace-period
members can use them normally. Existing quests, progress, rewards, security,
sync, and recovery remain available regardless of subscription state.
